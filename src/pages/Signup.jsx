...
const Signup = () => {
  ...
  const handleSelectGoogleAccount = async (email, name) => {
    ...
    try {
      ...
      setError(err || 'Failed to sign up with Google.');
    } finally {
      ...
      <div className="max-w-md mx-auto w-full">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-card border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block mb-1">Confirm Password</label>
              <input
                type="password"
